...
<head>
    ...
    <title>Masuk - Sistem Catatan Proyek Siswa RPL</title>
...
<body class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-slate-400">
            Masuk ke portal siswa untuk mencatat proyek Anda
        </p>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="glass-panel py-8 px-4 shadow-2xl rounded-2xl sm:px-10">
            ...
            @if (session('success'))
                <div class="mb-4 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs flex items-center gap-2">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-slate-300">Ingat saya</label>
                    </div>
                </div>
                ...
                <div>
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-arrow-right-to-bracket mr-2 self-center"></i>
                        Masuk Sekarang
                    </button>
                </div>
            </form>
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="bg-slate-900/20 px-2 text-slate-400">Belum punya akun?</span>
                    </div>
                </div>
